...
hosts = {
	"lp-labdesktop01-ubuntu": {
        "model"      : "hinet",
        "cfg"        : "hinet",
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "hinet" / "hinet-cityscapes-snow" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "hinet",
        "name"       : "hinet-cityscapes-snow",
        "num_classes": None,
        # "source"     : DATA_DIR / "lol" / "train" / "low",
        # "source"     : DATA_DIR / "sice" / "part2_900x1200_low" / "low",
        "source"     : DATA_DIR / "cityscapes" / "leftImg8bit-snow" / "train",
        "max_samples": None,
        "batch_size" : 1,
        # "img_size"   : None,
        "img_size"   : (3, 512, 512),
    ...
    "vsw-ws02": {
        "model"      : "hinet",
        "cfg"        : "hinet",
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "hinet" / "hinet-cityscapes-lol" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "hinet",
        "name"       : "hinet-cityscapes-lol",
        "num_classes": None,
        # "source"     : DATA_DIR / "lol" / "train" / "low",
        # "source"     : DATA_DIR / "sice" / "part2_900x1200_low" / "low",
        "source"     : DATA_DIR / "cityscapes" / "leftImg8bit-lol" / "val" / "low",
        "max_samples": None,
        "batch_size" : 1,
        # "img_size"   : None,
        "img_size"   : (3, 512, 512),
    ...
    "vsw-ws03": {
        "model"      : "hinet",
        "cfg"        : "hinet",
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "hinet" / "hinet-kodas-lol19" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "hinet",
        "name"       : "hinet-kodas-lol19",
        "num_classes": None,
        # "source"     : DATA_DIR / "lol" / "train" / "low",
        "source"     : DATA_DIR / "kodas" / "lol19" / "test" / "low",
        "max_samples": None,
        "batch_size" : 1,
        # "img_size"   : None,
        "img_size"   : (3, 512, 512),
