...
def predict(args: dict | box.Box) -> str:
    ...
    video_file = data_dir    / mon.Path(args.video)
    image_dir  = video_file.parent / video_file.stem / "image"
...
def main() -> str:
    ...
    parser.add_argument("--video", type=str, default="ic_11_01.mp4", help="Path to image folder")
