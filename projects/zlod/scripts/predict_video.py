...
gcenet_weights = project_dir / "weights/gcenet_mef.pt"
# gcenet_weights = project_dir / "weights/gcenet_bam.pt"
deim_config    = project_dir / "config/deim_dfine_s_coco80.yaml"
deim_weights   = project_dir / "weights/deim_dfine_s_coco80.pth"
camera_configs = {
    "darkface"      : {
        "iters"     : 8,
        "conf_thres": 0.40,
...
def main() -> str:
    ...
    parser.add_argument("--data-dir",   type=str, default="suwon#56_02_01", help="Path to image folder")
