...
def parse_args():
    ...
    parser.add_argument("--cfg",         type=str,            default="zeroadce-e",                  help="Model config.")
    ...
    parser.add_argument("--source",      type=str,            default=DATA_DIR / "test" / "01.mp4",  help="Data source.")
