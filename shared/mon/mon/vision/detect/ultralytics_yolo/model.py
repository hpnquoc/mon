...
class YOLOv11n(YOLOv11, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11n/coco80/yolov11n_coco80.pt",
            "num_classes": 80,
        },
        "widerface": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11n/widerface/yolov11n_widerface.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv11s(YOLOv11, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11s/coco80/yolov11s_coco80.pt",
            "num_classes": 80,
        },
        "widerface": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11s/widerface/yolov11s_widerface.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv11m(YOLOv11, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11m/coco80/yolov11m_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11l(YOLOv11, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11l/coco80/yolov11l_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11x(YOLOv11, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11x/coco80/yolov11x_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11n_OBB(YOLOv11_OBB, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11n_obb/dotav1/yolov11n_obb_dotav1.pt",
            "num_classes": 15,
        },
    })
...
class YOLOv11s_OBB(YOLOv11_OBB, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11s_obb/dotav1/yolov11s_obb_dotav1.pt",
            "num_classes": 15,
        },
    })
...
class YOLOv11m_OBB(YOLOv11_OBB, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11m_obb/dotav1/yolov11m_obb_dotav1.pt",
            "num_classes": 15,
        },
    })
...
class YOLOv11l_OBB(YOLOv11_OBB, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11l_obb/dotav1/yolov11l_obb_dotav1.pt",
            "num_classes": 15,
        },
    })
...
class YOLOv11x_OBB(YOLOv11_OBB, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11x_obb/dotav1/yolov11x_obb_dotav1.pt",
            "num_classes": 15,
        },
    })
...
class YOLOv11n_SEG(YOLOv11_SEG, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11n_seg/coco80/yolov11n_seg_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11s_SEG(YOLOv11_SEG, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11s_seg/coco80/yolov11s_seg_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11m_SEG(YOLOv11_SEG, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11m_seg/coco80/yolov11m_seg_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11l_SEG(YOLOv11_SEG, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11l_seg/coco80/yolov11l_seg_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11x_SEG(YOLOv11_SEG, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11x_seg/coco80/yolov11x_seg_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv11n_CLS(YOLOv11_CLS, ModelMixin):
    ...
    zoo : dict = box.Box({
        "imagenet": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11n_cls/imagenet/yolov11n_cls_imagenet.pt",
            "num_classes": 1000,
        },
    })
...
class YOLOv11s_CLS(YOLOv11_CLS, ModelMixin):
    ...
    zoo : dict = box.Box({
        "imagenet": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11s_cls/imagenet/yolov11s_cls_imagenet.pt",
            "num_classes": 1000,
        },
    })
...
class YOLOv11m_CLS(YOLOv11_CLS, ModelMixin):
    ...
    zoo : dict = box.Box({
        "imagenet": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11m_cls/imagenet/yolov11m_cls_imagenet.pt",
            "num_classes": 1000,
        },
    })
...
class YOLOv11l_CLS(YOLOv11_CLS, ModelMixin):
    ...
    zoo : dict = box.Box({
        "imagenet": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11l_cls/imagenet/yolov11l_cls_imagenet.pt",
            "num_classes": 1000,
        },
    })
...
class YOLOv11x_CLS(YOLOv11_CLS, ModelMixin):
    ...
    zoo : dict = box.Box({
        "imagenet": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11x_cls/imagenet/yolov11x_cls_imagenet.pt",
            "num_classes": 1000,
        },
    })
...
class YOLOv11n_POSE(YOLOv11_POSE, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco1": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11n_pose/coco1/yolov11n_pose_coco1.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv11s_POSE(YOLOv11_POSE, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco1": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11s_pose/coco1/yolov11s_pose_coco1.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv11m_POSE(YOLOv11_POSE, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco1": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11m_pose/coco1/yolov11m_pose_coco1.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv11l_POSE(YOLOv11_POSE, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco1": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11l_pose/coco1/yolov11l_pose_coco1.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv11x_POSE(YOLOv11_POSE, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco1": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov11/yolov11x_pose/coco1/yolov11x_pose_coco1.pt",
            "num_classes": 1,
        },
    })
...
class YOLOv12n(YOLOv12, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov12/yolov12n/coco80/yolov12n_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv12s(YOLOv12, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov12/yolov12s/coco80/yolov12s_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv12m(YOLOv12, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov12/yolov12m/coco80/yolov12m_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv12l(YOLOv12, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov12/yolov12l/coco80/yolov12l_coco80.pt",
            "num_classes": 80,
        },
    })
...
class YOLOv12x(YOLOv12, ModelMixin):
    ...
    zoo : dict = box.Box({
        "coco80": {
            "url"        : "",
            "path"       : ROOT_DIR / "zoo/ultralytics/yolov12/yolov12x/coco80/yolov12x_coco80.pt",
            "num_classes": 80,
        },
    })
