...
cfgs = {
    ...
    "finet-b-interleave-0.0": {
        "name"    : "finet-b-interleave-0.0",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.0, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.0, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.0, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.0, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.0, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.0, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.0, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.0, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.0, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.0, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.1": {
        "name"    : "finet-b-interleave-0.1",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.1, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.1, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.1, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.1, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.1, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.1, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.1, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.1, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.1, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.1, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.2": {
        "name"    : "finet-b-interleave-0.2",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.2, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.2, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.2, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.2, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.2, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.2, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.2, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.2, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.2, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.2, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.3": {
        "name"    : "finet-b-interleave-0.3",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.3, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.3, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.3, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.3, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.3, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.3, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.3, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.3, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.3, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.3, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.4": {
        "name"    : "finet-b-interleave-0.4",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.4, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.4, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.4, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.4, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.4, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.4, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.4, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.4, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.4, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.4, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.5": {
        "name"    : "finet-b-interleave-0.5",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.5, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.5, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.5, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.5, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.5, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.5, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.5, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.5, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.5, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.5, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.6": {
        "name"    : "finet-b-interleave-0.6",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.6, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.6, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.6, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.6, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.6, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.6, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.6, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.6, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.6, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.6, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.7": {
        "name"    : "finet-b-interleave-0.7",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.7, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.7, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.7, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.7, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.7, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.7, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.7, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.7, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.7, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.7, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.8": {
        "name"    : "finet-b-interleave-0.8",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.8, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.8, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.8, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.8, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.8, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.8, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.8, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.8, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.8, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.8, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-0.9": {
        "name"    : "finet-b-interleave-0.9",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.9, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.9, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.9, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.9, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.9, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.9, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.9, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.9, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.9, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.9, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-interleave-1.0": {
        "name"    : "finet-b-interleave-1.0",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 1.0, "interleave"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 1.0, "interleave"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 1.0, "interleave"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 1.0, "interleave"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 1.0, "interleave"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 1.0, "interleave"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 1.0, "interleave"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 1.0, "interleave"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 1.0, "interleave"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 1.0, "interleave"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.0": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.0, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.0, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.0, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.0, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.0, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.0, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.0, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.0, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.0, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.0, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.1": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.1, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.1, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.1, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.1, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.1, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.1, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.1, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.1, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.1, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.1, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.2": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.2, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.2, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.2, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.2, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.2, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.2, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.2, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.2, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.2, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.2, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.3": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.3, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.3, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.3, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.3, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.3, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.3, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.3, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.3, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.3, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.3, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.4": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.4, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.4, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.4, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.4, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.4, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.4, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.4, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.4, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.4, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.4, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.5": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.5, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.5, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.5, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.5, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.5, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.5, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.5, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.5, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.5, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.5, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.6": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.6, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.6, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.6, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.6, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.6, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.6, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.6, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.6, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.6, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.6, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.7": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.7, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.7, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.7, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.7, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.7, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.7, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.7, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.7, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.7, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.7, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.8": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.8, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.8, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.8, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.8, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.8, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.8, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.8, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.8, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.8, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.8, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-0.9": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 0.9, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 0.9, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 0.9, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 0.9, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.9, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 0.9, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 0.9, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 0.9, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 0.9, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 0.9, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-b-random-1.0": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      GhostConv2d,       [64, 2, 1, 3, 1, 1]],                             # 1  (x1)
            [[-1],         1,      FINetGhostConv,    [64,   True,  0.2, False, True, 1.0, "random"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetGhostConv,    [128,  True,  0.2, False, True, 1.0, "random"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetGhostConv,    [256,  True,  0.2, False, True, 1.0, "random"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetGhostConv,    [512,  True,  0.2, False, True, 1.0, "random"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 1.0, "random"]],  # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,       [1]],                                             # 11 (x1_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 12 (x1_1_skip)
            [4,            1,      ExtractItem,       [1]],                                             # 13 (x1_2)
            ...
            [[-1, 25],     1,      Concat,            []],                                              # 28 (x2 + sam_features)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 1, 1, 0]],                            # 29 (x2)
            [[-1, 11, 23], 1,      FINetGhostConv,    [64,   True,  0.2, True,  True, 1.0, "random"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,       [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetGhostConv,    [128,  True,  0.2, True,  True, 1.0, "random"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,       [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetGhostConv,    [256,  True,  0.2, True,  True, 1.0, "random"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,       [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetGhostConv,    [512,  True,  0.2, True,  True, 1.0, "random"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,       [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetGhostConv,    [1024, False, 0.2, False, True, 1.0, "random"]],  # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,       [1]],                                             # 39 (x2_1)
            [-1,           1,      GhostConv2d,       [64,  2, 1, 3, 1, 1]],                            # 40 (x2_1_skip)
            [32,           1,      ExtractItem,       [1]],                                             # 41 (x2_2)
    ...
    "finet-c-interleave-0.0": {
        "name"    : "finet-c-interleave-0.0",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.1": {
        "name"    : "finet-c-interleave-0.1",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.2": {
        "name"    : "finet-c-interleave-0.2",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.3": {
        "name"    : "finet-c-interleave-0.3",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.4": {
        "name"    : "finet-c-interleave-0.4",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.5": {
        "name"    : "finet-c-interleave-0.5",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.6": {
        "name"    : "finet-c-interleave-0.6",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.7": {
        "name"    : "finet-c-interleave-0.7",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.8": {
        "name"    : "finet-c-interleave-0.8",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-0.9": {
        "name"    : "finet-c-interleave-0.9",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
    ...
    "finet-c-interleave-1.0": {
        "name"    : "finet-c-interleave-1.0",
        "channels": 3,
        "backbone": [
            # [from,       number, module,            args(out_channels, ...)]
            [-1,           1,      Identity,          []],                                              # 0  (x)
