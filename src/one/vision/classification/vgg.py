    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(
            ...
            pretrained  = VGG.init_pretrained(pretrained),
            phase       = phase,
            loss        = loss,
            metrics     = metrics,
