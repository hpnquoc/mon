...
@MODELS.register(name="resnext")
class ResNeXt(ImageClassificationModel):
    """
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(
            ...
            pretrained  = ResNeXt.init_pretrained(pretrained),
            phase       = phase,
            loss        = loss,
            metrics     = metrics,
