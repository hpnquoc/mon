...
from mon.vision.datatype.annotation.bbox import *
from mon.vision.datatype.annotation.contour import *
from mon.vision.datatype.annotation.depth import *
from mon.vision.datatype.annotation.image import *
from mon.vision.datatype.annotation.label_map import *
