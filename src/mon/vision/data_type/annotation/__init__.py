...
from mon.vision.data_type.annotation.bbox import *
from mon.vision.data_type.annotation.contour import *
from mon.vision.data_type.annotation.depth import *
from mon.vision.data_type.annotation.image import *
from mon.vision.data_type.annotation.label_map import *
