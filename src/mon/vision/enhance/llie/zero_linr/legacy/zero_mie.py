...
class MLP_RGB(MLP):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        self.value_net  = nn.INRPatchEncoder(window_size, mid_channels, down_size, hidden_layers, omega_0, first_bias_scale, nonlinear, weight_decay[1])
        self.coords_net = nn.INRCoordinatesEncoder(mid_channels, down_size, hidden_layers, omega_0, first_bias_scale, nonlinear, weight_decay[0])
        self.output_net = nn.INRDecoder(hidden_channels, self.out_channels, out_layers, omega_0, nonlinear, weight_decay[2])
...
class MLP_RGB_D(MLP):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        self.value_net  = nn.INRPatchEncoder(window_size, mid_channels, down_size, hidden_layers, omega_0, first_bias_scale, nonlinear, weight_decay[1])
        self.depth_net  = nn.INRPatchEncoder(window_size, mid_channels, down_size, hidden_layers, omega_0, first_bias_scale, nonlinear, weight_decay[1])
        self.edge_net   = nn.INRPatchEncoder(window_size, mid_channels, down_size, hidden_layers, omega_0, first_bias_scale, nonlinear, weight_decay[1])
        self.coords_net = nn.INRCoordinatesEncoder(mid_channels, down_size, hidden_layers, omega_0, first_bias_scale, nonlinear, weight_decay[0])
        self.output_net = nn.INRDecoder(hidden_channels, self.out_channels, out_layers, omega_0, nonlinear, weight_decay[2])
        self.dba        = nn.BoundaryAwarePrior(eps=dba_eps, normalized=False)
