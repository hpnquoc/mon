        ...
        for i, datapoint in pbar.track(
            ...
            if save_debug:
                if keep_subdirs:
                    ...
                    debug_dir =  save_dir / rel_path.parents[1] / rel_path.parent.name
                else:
                    debug_dir =  save_dir / data_name
                output_path   = debug_dir / "denoise" / f"{image_path.stem}{mon.SAVE_IMAGE_EXT}"
                output_path.parent.mkdir(parents=True, exist_ok=True)
