...
class NeRComodel(BaseModel):
    ...
    def backward_G(self):
        ...
        loss_Bypass = self.criterionCycle(self.fake_B, self.real_A + self.H) + self.criterionCycle(self.real_B, self.G_A_real_B_minus_H)
        ...
        loss_self   = self.criterionCycle(self.H, self.fake_B - self.real_A) + self.criterionCycle(self.fake_A, self.real_B - netH_fake_A_concat_ca)
