...
def fisheye_transform_image_and_bbox(
    ...
    transformed_bboxes = fisheye_transform_bbox2(bbox, (w0, h0), (w1, h1), distortion, area_thres, aspect_thres)
...
class FisheyeTransform(DualTransform):
    ...
    def apply_to_bboxes(
        ...
        *args: Any, **params: Any
        ...
        return fisheye_transform_bbox2(bboxes, old_size, new_size, self.distortion, self.area_thres, self.aspect_thres)
