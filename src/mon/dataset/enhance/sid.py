...
class SIDSony(vision.VisionDataset):
...
class SIDSonyDataModule(core.DataModule):
    ...
    def setup(self, stage: Literal["train", "test", "predict", None] = None):
        ...
        if stage in [None, "train"]:
            self.train = SIDSony(split=core.Split.TRAIN, **self.dataset_kwargs)
            self.val   = SIDSony(split=core.Split.VAL, **self.dataset_kwargs)
        if stage in [None, "test"]:
            self.test  = SIDSony(split=core.Split.TEST, **self.dataset_kwargs)
