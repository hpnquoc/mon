...
class Rain1400(vision.VisionDataset):
...
class Rain1400DataModule(core.DataModule):
    ...
    def setup(self, stage: Literal["train", "test", "predict", None] = None):
        ...
        if stage in [None, "train"]:
            self.train = Rain1400(split=core.Split.TRAIN, **self.dataset_kwargs)
            self.val   = Rain1400(split=core.Split.TEST,  **self.dataset_kwargs)
        if stage in [None, "test"]:
            self.test  = Rain1400(split=core.Split.TEST,  **self.dataset_kwargs)
