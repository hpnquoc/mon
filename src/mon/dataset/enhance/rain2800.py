...
class Rain2800(vision.VisionDataset):
...
class Rain2800DataModule(core.DataModule):
    ...
    def setup(self, stage: Literal["train", "test", "predict", None] = None):
        ...
        if stage in [None, "train"]:
            self.train = Rain2800(split=core.Split.TEST, **self.dataset_kwargs)
            self.val   = Rain2800(split=core.Split.TEST, **self.dataset_kwargs)
        if stage in [None, "test"]:
            self.test  = Rain2800(split=core.Split.TEST, **self.dataset_kwargs)
