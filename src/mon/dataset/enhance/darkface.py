...
class DarkFace(MultimodalDataset):
    """DarkFace dataset consists of 496 low-light images."""
...
class DarkFaceFull(MultimodalDataset):
...
class DarkFaceFullDataModule(DataModule):
