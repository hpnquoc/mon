...
class BAM(torch.nn.Module):
    ...
    class Flatten(torch.nn.Module):
        def forward(self, input: torch.Tensor) -> torch.Tensor:
            ...
            Returns:
                Flattened tensor as a ``torch.Tensor`` with shape [B, -1].
            """
    ...
    class ChannelAttention(torch.nn.Module):
        ...
        def forward(self, input: torch.Tensor) -> torch.Tensor:
            ...
            Returns:
                Attention weights tensor as a ``torch.Tensor`` with shape [B, C, H, W].
            """
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            Output tensor as a ``torch.Tensor`` with shape [B, C, H, W] with
            attention applied.
        """
