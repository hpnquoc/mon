...
@click.option("--image-dir", type=click.Path(exists=True),  default=mon.DATA_DIR/"aicity/aicity_2024_fisheye8k/train", help="Image directory.")
@click.option("--label-dir", type=click.Path(exists=True),  default=mon.DATA_DIR/"aicity/aicity_2024_fisheye8k/train", help="Bounding bbox directory.")
